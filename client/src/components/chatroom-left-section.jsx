...
import LeftNav from './left-nav.components';
import Contacts from './contact.component';
import UserMessageHistory from './user-message-history.component';
...
class ChatroomLeftSection extends React.PureComponent {
  ...
  render() {
    return (
        <aside className='chatroom__left-section' style={this.state.isMobile ? this.state.leftSectionStyling : {}}>
          {this.navComponents()}
        </aside>            
    )
  }
